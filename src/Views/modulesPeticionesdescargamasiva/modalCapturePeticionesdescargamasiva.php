        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-peticionesdescargamasiva" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="hastaFecha" class="col-sm-2 col-form-label">Archivos en XML en RAR</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                </div>
                                <input readonly type="input" name="xmlENRAR" id="xmlENRAR" class="form-control <?= session('error.xmlENRAR') ? 'is-invalid' : '' ?>" value="0" placeholder="" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="hastaFecha" class="col-sm-2 col-form-label">XML Registrados en Tabla</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                </div>
                                <input readonly type="input" name="xmlTabla" id="xmlTabla" class="form-control <?= session('error.xmlTabla') ? 'is-invalid' : '' ?>" value="0" placeholder="" autocomplete="off">
                            </div>
                        </div>
                    </div>
